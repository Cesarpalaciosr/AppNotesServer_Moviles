...
const signUp = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const user = yield user_1.default.findOne({ email: req.body.email, username: req.body.username });
    console.log(user);
    if (user) {
...
const edituser = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const user = yield user_1.default.updateOne({ _id: req.body._id }, { name: req.body.name, lastname: req.body.lastname, username: req.body.username });
    if (!user) {
